# TÀI LIỆU CHUẨN AlumGlass v27 — BẢN ĐẦY ĐỦ (FULL: MASTER DATA + GIẢI THÍCH ENGINE + VÍ DỤ TRIỂN KHAI CHI TIẾT TỪNG BƯỚC)
## Sản phẩm mẫu: Cửa đi 2 cánh mở quay + ô kính cố định trên (CDMQ-2C-TRANSOM)

> Đây là bản **hợp nhất cuối cùng**, gộp nguyên vẹn tài liệu chuẩn v27 (nguồn chân lý duy nhất để triển khai) với phần **giải thích cơ chế Formula Engine** và **ví dụ tính toán mở rộng từng phép thay số** cho dễ đọc, dễ đối chiếu khi code. Không có nội dung nào của bản v27 gốc bị lược bớt — chỉ được **bổ sung thêm**, đánh dấu rõ bằng tiêu đề "(BỔ SUNG)".
>
> Toàn bộ số liệu trong tài liệu này đã được sửa 2 sai số cộng dồn và 1 lỗi kiến trúc so với bản v26/Grok gốc — chi tiết ở Changelog (mục 0) và Phụ lục (mục 10).
...
**Tài liệu này là bản chuẩn duy nhất (đầy đủ, có giải thích cơ chế engine + ví dụ mở rộng từng bước) để triển khai AlumGlass cho sản phẩm CDMQ-2C-TRANSOM. Mọi bản trước (v26, các bản review trung gian, bản v27 gốc chưa gộp) coi như đã được hợp nhất và thay thế hoàn toàn bởi tài liệu này.**
