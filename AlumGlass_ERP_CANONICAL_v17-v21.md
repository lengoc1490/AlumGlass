...
> **Đánh dấu phiên bản:** ★v18/★v19/★v20/★v21 = nội dung bổ sung/sửa đổi ở phiên bản tương ứng, giữ nguyên trong bản hợp nhất này để truy vết nguồn gốc quyết định.
...
- **PHẦN A — NỀN TẢNG:** I. Nguyên tắc thiết kế (25) + QĐ-21→25 · II. Kiến trúc tổng thể 8 tầng · III. Danh mục 62 DocType
- **PHẦN B — TẦNG 1: MASTER DATA:** IV. DocType nền tảng đầy đủ trường (gồm 4.23 ★v20 P0 — tồn kho màu theo Batch) · V. Custom Fields trên ERPNext core · VI. Master Data mẫu chuẩn
...
- **PHẦN F — TẦNG 6: MODULE NGHIỆP VỤ:**
  ...
  - XX. Material Planning (MRP Lite, input theo Batch-màu ★v20)
...
- **PHẦN H — VẬN HÀNH:** XXX. ConfigSnapshot & Audit Trail xuyên suốt · XXXI. Quy trình đầu-cuối · XXXII. Phân quyền & Vai trò · XXXIII. Ví dụ kiểm chứng · XXXIV. Lộ trình triển khai · XXXV. Rủi ro & điểm theo dõi (26 rủi ro) · XXXVI. Checklist Go-live
...
## I. NGUYÊN TẮC THIẾT KẾ (25 NGUYÊN TẮC BẤT BIẾN — hợp nhất v11→v21)
...
TẦNG 6 — MODULE LAYER (Hook-based, đăng ký qua hooks.py, không sửa Tầng 3-4)
  ...
  6B Supply     : Material Planning (MRP Lite, theo Item gốc + color_code ★v20) · Cost Variance Analysis (vật tư)
...
## III. DANH MỤC 62 DOCTYPE (TỔNG HỢP THEO TẦNG, hợp nhất v17→v21)

### Tầng 1 — Master Data (20 DocType lõi + 6 mới)
...
**Tổng: 60 DocType chính thức + field bổ sung = phạm vi triển khai đầy đủ.** (★ = mới so với v17/v18; ★v20/★v21 = bổ sung ở các phiên bản sau, hợp nhất trong tài liệu này)
...
## XXXIV. LỘ TRÌNH TRIỂN KHAI TỔNG THỂ (PHASE 0–8, hợp nhất v19→v21)

| Phase | Nội dung | Điều kiện hoàn thành |
|---|---|---|
| **Phase 0 ★v20 — chèn TRƯỚC mọi phase khác** | **Sửa lỗi kiến trúc tồn kho màu (§4.23)**: tạo `AL Color Standard`, bật Batch cho Item nhôm/vật tư áp dụng, migration nếu đã lỡ tạo Item Variant | Không còn Item Variant theo màu nào tồn tại trong hệ thống trước khi Phase 3 bắt đầu; MRP Lite chạy thử với dữ liệu Batch cho ≥1 dự án thí điểm khớp thủ công |
...
| **2 — Module Commercial** | BOM Version, Approval, Discount, Reporting cơ bản, MRP Lite (theo Batch-màu), Cost Variance, Notification, Sales Analytics | Ví dụ E-G PASS |
...
| **3 — Sản Xuất** | Cutting Standard, Aluminum/Glass Cutting Plan, Cut Order (đã cập nhật theo §4.23) | Ví dụ I PASS; phế liệu đo được giảm so với baseline; **không phát sinh Item mới trong toàn bộ Phase 3** |
...
*AlumGlass ERP — Đặc Tả Hợp Nhất (Canonical) · Kế thừa toàn bộ v11 → v13 → v14 → v15 → v16 → v17 → v18 → v19 → v20 → v21*
