...
CUSTOM_FIELDS = {
    ...
    # ── Quotation Item (chỉ giữ BOM ref + JSON input động + kết quả) ──
    "Quotation Item": [
        ...
        {"fieldname": "al_bom_vars", "label": "BOM Input Variables", "fieldtype": "JSON",
         "insert_after": "al_bom_version",
         "description": "Tham số đầu vào động cho BOM. VD: {\"W_mm\":2400,\"H_mm\":2600,\"n_panel\":2,\"aluminum_color\":\"WHITE\",...}. Mỗi sản phẩm có bộ tham số khác nhau."},
        {"fieldname": "al_config_snapshot", "label": "Config Snapshot", "fieldtype": "Link",
        ...
        {"fieldname": "al_tong_vl", "label": "Tổng vật liệu", "fieldtype": "Currency",
         "insert_after": "al_gia_vat", "read_only": 1},
        {"fieldname": "al_vl_nhom", "label": "VL Nhôm", "fieldtype": "Currency",
         "insert_after": "al_tong_vl", "read_only": 1},
        {"fieldname": "al_vl_kinh", "label": "VL Kính", "fieldtype": "Currency",
         "insert_after": "al_vl_nhom", "read_only": 1},
        {"fieldname": "al_vl_vtp", "label": "VL Phụ trợ", "fieldtype": "Currency",
         "insert_after": "al_vl_kinh", "read_only": 1},
        {"fieldname": "al_vl_pk", "label": "VL Phụ kiện", "fieldtype": "Currency",
         "insert_after": "al_vl_vtp", "read_only": 1},
    ],
    # ── Sales Order ────────────────────────────────────
    "Sales Order": [
