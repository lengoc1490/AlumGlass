...
9. [Cấu hình nâng cao](#9-c%E1%BA%A5u-h%C3%ACnh-n%C3%A2ng-cao)
...
### 9.1. Kết hợp nhiều cấu hình trong một report
...
### 9.2. Sử dụng trong Report Builder (không cần code JS)
...
### 9.3. Override từng report bằng localStorage
...
> **Tài liệu liên quan:** [Report Aggregation Dropdown UI](../usage/report-agg-dropdown.md) | [Report System Overview](../overview.md)
